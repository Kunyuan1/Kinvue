...
const SUBMIT_FAILURE: Record<SubmitFailure, string> = {
  ...
  // it, and stops. The path is deliberately not in here: the dashboard beneath
  // already shows the store's own sentence, path included, from when the list
  // first failed to load (#95).
  'store-unreadable':
